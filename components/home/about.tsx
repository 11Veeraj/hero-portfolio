...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        Passionate software engineer driven by innovation and continuous learning,
        {" "}
      </span>
      <span
      ...
      >
        I strive to shape the future of technology 
        through impactful contributions and entrepreneurial endeavors.
      </span>
    </h1>
  );
