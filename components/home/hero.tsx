...
const HeroSection = React.memo(() => {
  ...
  const renderBackgroundImage = (): React.ReactNode => (
    <div className={HERO_STYLES.BG_WRAPPER} style={{ maxHeight: "650px", textAlign: "right", width: "100%" }}>
      <img 
        src="backgroundDesign.jpg" 
  ...
  const renderHeroContent = (): React.ReactNode => (
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        ...
        <h1 className="text-3xl seq">I am Veeraj Goudar</h1>
      </div>
      <p className="mb-4">
